            ...
            <form action="controller/PessoaController.php" method="post" validate>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="dtnaspes">Data de Nascimento</label>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
              ...
              <div class="row">
                <div class="form-group col-md-7">
                  <label for="emailpes">E-mail</label>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                ...
                <div class="form-group col-md-5">
                  <label for="telpes">Telefone</label>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
              ...
              <div class="row">
                <div class="form-group col-md-6">
                  <label for="civpes">Estado Cívil</label>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
                ...
                <div class="form-group col-md-6">
                  <label for="propes">Profissão</label>
                  <div class="input-group">
                    <span class="input-group-addon" id="basic-addon1"><i class="fa fa-user"></i></span>
